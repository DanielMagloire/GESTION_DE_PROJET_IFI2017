...
public class FileActualiteApplication implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		Actualite actualite = new Actualite("Recrutement en master recherche en informatique SIM IFI 2018", "Administration IFI", new Date(), "ifi"+i+".jpg", "L'IFI lance <strong>le recrutement</strong> pour l'accès au master recherche SIM pour le compte de l'année académique 2018-2019");
